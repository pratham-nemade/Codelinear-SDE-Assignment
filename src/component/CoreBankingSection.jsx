        ...
        <section className="relative overflow-hidden py-14">
            ...
            <div className="relative z-10 mx-auto flex flex-col items-center gap-12 pl-6 sm:pl-10 lg:flex-row lg:justify-between lg:gap-20 lg:pl-16 xl:pl-20">
                <div className="w-full max-w-180 lg:w-[64%]">
                    ...
                    <div style={gradientBorder} className="mt-10 inline-block rounded-xl">
                        <button className="font-chivo cursor-pointer rounded-xl bg-[linear-gradient(106.53deg,#00B4FD_-5.68%,#003ACE_86.98%)] px-8 py-3 text-[14px] uppercase tracking-[0.14em] text-white">
                            Request Demo
                        </button>
                    </div>
